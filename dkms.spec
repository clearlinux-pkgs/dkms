...
Version  : 2.7.1
Release  : 4
URL      : https://github.com/dell/dkms/archive/v2.7.1/dkms-2.7.1.tar.gz
Source0  : https://github.com/dell/dkms/archive/v2.7.1/dkms-2.7.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571265881
...
cp %{_builddir}/dkms-2.7.1/COPYING %{buildroot}/usr/share/package-licenses/dkms/74a8a6531a42e124df07ab5599aad63870fa0bd4
cp %{_builddir}/dkms-2.7.1/debian/copyright %{buildroot}/usr/share/package-licenses/dkms/067232c177e4ca3ee7f5f71dbec011f22e9a4694
%make_install
