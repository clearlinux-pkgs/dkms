...
Version  : 3.0.9
Release  : 23
URL      : https://github.com/dell/dkms/archive/v3.0.9/dkms-3.0.9.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.0.9/dkms-3.0.9.tar.gz
...
%prep
%setup -q -n dkms-3.0.9
cd %{_builddir}/dkms-3.0.9
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670874331
