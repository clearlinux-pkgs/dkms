...
Version  : 3.0.3
Release  : 16
URL      : https://github.com/dell/dkms/archive/v3.0.3/dkms-3.0.3.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.0.3/dkms-3.0.3.tar.gz
...
%prep
%setup -q -n dkms-3.0.3
cd %{_builddir}/dkms-3.0.3
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641336709
...
cp %{_builddir}/dkms-3.0.3/COPYING %{buildroot}/usr/share/package-licenses/dkms/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
