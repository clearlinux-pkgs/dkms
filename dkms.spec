...
Version  : 2.8.3
Release  : 8
URL      : https://github.com/dell/dkms/archive/v2.8.3/dkms-2.8.3.tar.gz
Source0  : https://github.com/dell/dkms/archive/v2.8.3/dkms-2.8.3.tar.gz
...
%prep
%setup -q -n dkms-2.8.3
cd %{_builddir}/dkms-2.8.3
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594844343
...
cp %{_builddir}/dkms-2.8.3/COPYING %{buildroot}/usr/share/package-licenses/dkms/74a8a6531a42e124df07ab5599aad63870fa0bd4
cp %{_builddir}/dkms-2.8.3/debian/copyright %{buildroot}/usr/share/package-licenses/dkms/067232c177e4ca3ee7f5f71dbec011f22e9a4694
%make_install
...
/usr/share/package-licenses/dkms/74a8a6531a42e124df07ab5599aad63870fa0bd4
