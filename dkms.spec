...
Version  : 3.0.0
Release  : 14
URL      : https://github.com/dell/dkms/archive/v3.0.0/dkms-3.0.0.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.0.0/dkms-3.0.0.tar.gz
...
%prep
%setup -q -n dkms-3.0.0
cd %{_builddir}/dkms-3.0.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636568203
...
cp %{_builddir}/dkms-3.0.0/COPYING %{buildroot}/usr/share/package-licenses/dkms/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
