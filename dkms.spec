...
Version  : 2.8.6
Release  : 11
URL      : https://github.com/dell/dkms/archive/v2.8.6/dkms-2.8.6.tar.gz
Source0  : https://github.com/dell/dkms/archive/v2.8.6/dkms-2.8.6.tar.gz
...
%prep
%setup -q -n dkms-2.8.6
cd %{_builddir}/dkms-2.8.6
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630885913
...
cp %{_builddir}/dkms-2.8.6/COPYING %{buildroot}/usr/share/package-licenses/dkms/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/dkms-2.8.6/debian/copyright %{buildroot}/usr/share/package-licenses/dkms/067232c177e4ca3ee7f5f71dbec011f22e9a4694
%make_install
