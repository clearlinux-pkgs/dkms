...
Version  : 3.1.4
Release  : 37
URL      : https://github.com/dell/dkms/archive/v3.1.4/dkms-3.1.4.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.1.4/dkms-3.1.4.tar.gz
...
%prep
%setup -q -n dkms-3.1.4
cd %{_builddir}/dkms-3.1.4
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736808592
