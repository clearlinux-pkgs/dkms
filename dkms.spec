...
%prep
%setup -q -n dkms-2.8.1
cd %{_builddir}/dkms-2.8.1
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/dkms-2.8.1/debian/copyright %{buildroot}/usr/share/package-licenses/dkms/067232c177e4ca3ee7f5f71dbec011f22e9a4694
%make_install
