...
Version  : 3.1.8
Release  : 41
URL      : https://github.com/dell/dkms/archive/v3.1.8/dkms-3.1.8.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.1.8/dkms-3.1.8.tar.gz
...
%prep
%setup -q -n dkms-3.1.8
cd %{_builddir}/dkms-3.1.8
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744403749
