...
Version  : 3.1.6
Release  : 39
URL      : https://github.com/dell/dkms/archive/v3.1.6/dkms-3.1.6.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.1.6/dkms-3.1.6.tar.gz
...
%prep
%setup -q -n dkms-3.1.6
cd %{_builddir}/dkms-3.1.6
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742399858
