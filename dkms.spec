...
Version  : 3.0.7
Release  : 21
URL      : https://github.com/dell/dkms/archive/v3.0.7/dkms-3.0.7.tar.gz
Source0  : https://github.com/dell/dkms/archive/v3.0.7/dkms-3.0.7.tar.gz
...
%prep
%setup -q -n dkms-3.0.7
cd %{_builddir}/dkms-3.0.7
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664289429
