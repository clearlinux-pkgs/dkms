...
Version  : 2.8.8
Release  : 13
URL      : https://github.com/dell/dkms/archive/v2.8.8/dkms-2.8.8.tar.gz
Source0  : https://github.com/dell/dkms/archive/v2.8.8/dkms-2.8.8.tar.gz
...
%prep
%setup -q -n dkms-2.8.8
cd %{_builddir}/dkms-2.8.8
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635975932
...
cp %{_builddir}/dkms-2.8.8/COPYING %{buildroot}/usr/share/package-licenses/dkms/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
